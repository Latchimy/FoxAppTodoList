...
class HomeController extends GetxController {
  ...
  updateTask(Task task, String title) {
    ...
    var todo = {'title': title, 'fait': false};
    todos.add(todo);
  ...
  bool addTodo(String title) {
    ...
    var doneTodo = {'title': title, 'fait': true};
    if (doneTodos
  ...
  void updateTodos() {
    ...
    int oldIx = tasks.indexOf(task.value);
    tasks[oldIx] = newTask;
    tasks.refresh();
  }

  void doneTodo(String title) {
    var doingTodo = {'title': title, 'fait': false};
